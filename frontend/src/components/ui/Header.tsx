...
import IPFLogo from "../../app/assets/IPF.png"; // Ajuste o caminho conforme necessário
    ...
    <header className="bg-white shadow-sm border-b border-gray-100 p-3 sm:px-6">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <nav className="flex items-center space-x-4 sm:space-x-6">
          ...
          <Link
            href="/"
            className="text-[#0F4D2E] hover:text-[#3FA34D] transition-colors duration-200 text-base sm:text-lg font-medium"
          >
            Início
          </Link>
          ...
          {isLoggedIn ? (
            ...
            // Se não logado
            <button className="px-3 py-1 sm:px-4 sm:py-2 bg-white border border-gray-200 text-[#0F4D2E] rounded-md shadow-sm hover:bg-[#F5FCF7] hover:text-[#3FA34D] transition-colors duration-200">
              Login
            </button>
          )}
        </nav>
